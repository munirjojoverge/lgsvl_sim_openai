...
urban_AD_env_path = pathname + '/open_ai_env'
...
def default_args():    
    ...
    ###############################################################
    env =  'LG-SIM-ENV-v0' #'urban_AD-multilane-v1' #'sidepass-v0' #'urban_AD-merge-v1' #'parking-v1' #'continuous-multi-env-v1' #'continuous-env-v1' 'parking-v1'
    alg = 'her'
    network = 'mlp'
    num_timesteps = '1e2'
    ...
    load_path = save_folder +'/'+ '20190419-113140' #her_default_20190212-141935' # Good with just Ego
